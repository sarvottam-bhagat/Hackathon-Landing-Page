        ...
        <div className="flex flex-col items-center opacity-0 translate-y-10 transition-all duration-1000">
          <div className="mb-12 text-center">
            <div className="pulse-chip mb-4">
              ...
              <span>Meet the Technology</span>
            </div>
            <h2 className="text-3xl sm:text-4xl md:text-5xl font-display font-bold mb-4">
              Advanced Retrieval Meets <span className="text-[#FC4D0A]">Intelligent AI</span>
            </h2>
            <p className="text-lg text-gray-600 max-w-3xl mx-auto">
              Our RAG AI system represents the perfect fusion of cutting-edge information retrieval and 
              state-of-the-art artificial intelligence, designed to seamlessly integrate into knowledge workflows.
            </p>
          </div>
          ...
          <div className="relative w-full max-w-4xl overflow-hidden rounded-3xl shadow-2xl">
            <img 
              ...
              alt="Advanced AI system interface with intelligent retrieval capabilities" 
              className="w-full object-cover"
            />
            <div className="absolute bottom-0 left-0 right-0 bg-gradient-to-t from-black/70 to-transparent p-8">
              <div className="flex items-center justify-between">
                <div>
                  <h3 className="text-white text-xl font-semibold">Next Generation Intelligence</h3>
                  <p className="text-white/80">Designed for knowledge discovery</p>
                </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-6 mt-12">
            <div className="bg-white p-6 rounded-xl shadow-elegant hover:shadow-elegant-hover transition-all duration-300">
              ...
              <h4 className="text-lg font-semibold mb-2">Semantic Understanding</h4>
              <p className="text-gray-600">Advanced language models provide deep contextual awareness and meaning-based retrieval.</p>
            </div>
            ...
            <div className="bg-white p-6 rounded-xl shadow-elegant hover:shadow-elegant-hover transition-all duration-300">
              ...
              <p className="text-gray-600">Continuously learns from queries to improve retrieval accuracy and personalize responses.</p>
            </div>
            ...
            <div className="bg-white p-6 rounded-xl shadow-elegant hover:shadow-elegant-hover transition-all duration-300">
              ...
              <p className="text-gray-600">Lightning-fast retrieval and generation with sub-second response times for optimal user experience.</p>
            </div>
          </div>
        </div>
      </div>
