      ...
      <div className="section-container">
        <div className="text-center mb-10 sm:mb-16">
          ...
          <h2 className="section-title mb-3 sm:mb-4 opacity-0 fade-in-element">
            Advanced Intelligence, <br className="hidden sm:block" />AI-Powered Understanding
          </h2>
          <p className="section-subtitle mx-auto opacity-0 fade-in-element">
            Built with cutting-edge RAG technology to understand, learn, and adapt to your knowledge needs.
          </p>
        </div>
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-4 sm:gap-6 md:gap-8">
          <FeatureCard
            ...
            description="Our RAG AI learns from your queries and interactions, continuously improving retrieval accuracy and response quality."
            index={0}
          />
          <FeatureCard
            ...
            description="Communicate using natural language queries. Our AI understands context and intent to deliver precise information."
            index={1}
          />
          <FeatureCard
            ...
            description="Advanced language models provide deep contextual awareness and meaning-based document retrieval capabilities."
            index={2}
          />
          <FeatureCard
            ...
            description="Advanced indexing and mapping technology allows our AI to navigate complex knowledge bases with precision."
            index={3}
          />
          <FeatureCard
            ...
            description="Built-in privacy protocols protect your data and ensure secure information retrieval with enterprise-grade encryption."
            index={4}
          />
          <FeatureCard
            ...
            description="From simple queries to complex research tasks, our RAG AI can assist with a wide range of knowledge work."
            index={5}
          />
        </div>
      </div>
